...
#状況が変わった場合
	#if now != prev
		#得点が入った場合
		if data["一走状況"] == "1" || data["二走状況"] == "1" || data["三走状況"] == "1" || data["打者状況"] == "1"then
			#一塁ランナーが得点した場合
			if data["一走状況"] == "1"
				#配列patternの中に0000がある場合
				if pattern.include?("0000")
...
puts((score["0001"] / occur["0001"].to_f).round(3))
puts((score["1001"] / occur["1001"].to_f).round(3))
puts((score["2001"] / occur["2001"].to_f).round(3))
puts((score["0010"] / occur["0010"].to_f).round(3))
puts((score["1010"] / occur["1010"].to_f).round(3))
puts((score["2010"] / occur["2010"].to_f).round(3))
puts((score["0100"] / occur["0100"].to_f).round(3))
puts((score["1100"] / occur["1100"].to_f).round(3))
puts((score["2100"] / occur["2100"].to_f).round(3))
puts((score["0011"] / occur["0011"].to_f).round(3))
puts((score["1011"] / occur["1011"].to_f).round(3))
puts((score["2011"] / occur["2011"].to_f).round(3))
puts((score["0110"] / occur["0110"].to_f).round(3))
puts((score["1110"] / occur["1110"].to_f).round(3))
puts((score["2110"] / occur["2110"].to_f).round(3))
puts((score["0101"] / occur["0101"].to_f).round(3))
puts((score["1101"] / occur["1101"].to_f).round(3))
puts((score["2101"] / occur["2101"].to_f).round(3))
puts((score["0111"] / occur["0111"].to_f).round(3))
puts((score["1111"] / occur["1111"].to_f).round(3))
puts((score["2111"] / occur["2111"].to_f).round(3))
