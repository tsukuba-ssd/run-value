...
#各イベントの総数
ivent = {"単打" => 0, "二塁打" => 0, "三塁打" => 0, "本塁打" => 0, "凡打死" => 0, "凡打出塁" => 0, "空振り三振" => 0, "見逃し三振" => 0, "三振" => 0, "四球" => 0, "死球" => 0, "犠打" => 0, "犠飛" => 0, "アウト" => 0}
#各イベントの合計値
total = {"単打" => 0, "二塁打" => 0, "三塁打" => 0, "本塁打" => 0, "凡打死" => 0, "凡打出塁" => 0, "空振り三振" => 0, "見逃し三振" => 0, "三振" => 0, "四球" => 0, "死球" => 0, "犠打" => 0, "犠飛" => 0, "アウト" => 0}
#アウト、出塁をどうするか
...
csv_data.each do |data|
 ...
 # p ivent
  ...
  puts ((total["犠飛"] / ivent["犠飛"].to_f).round(3))
	puts ((total["アウト"] / ivent["アウト"].to_f).round(3))
